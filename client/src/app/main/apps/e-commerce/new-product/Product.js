...
function Product(props, initialState, onSubmit) {
	...
	// 	return form.name.length > 0 && !_.isEqual(form);
	// }
	// {
	// 	return <FuseLoading />;
	// }
							...
							<div className="flex items-center max-w-full">
								...
								<div className="flex flex-col min-w-0 mx-8 sm:mc-16">
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
										<Typography className="text-16 sm:text-20 truncate">New Product</Typography>
									</FuseAnimate>
									<FuseAnimate animation="transition.slideLeftIn" delay={300}>
